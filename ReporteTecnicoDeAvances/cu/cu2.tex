...
\begin{UseCase}{CU2}{Modificar información personal}{
		...
		\UCitem{Reglas de Negocio}{\BRref{RN1}{Unicidad del usuario}, \BRref{RN6}{Información requerida para agregar un usuario}, \BRref{RN20}{Longitud de número de boleta alumno y número de empleado}.}
	...
	\begin{UCtrayectoria}{Principal}
		\UCpaso[\UCactor] Selecciona la opción {\bf Modificar datos} del {\bf Menú de sesión} en la pantalla de \IUref{IU5.1}{Bienvenida usuarios}.
		\UCpaso Muestra la pantalla \IUref{IU2}{Modificar información personal}.
		...
		\UCpaso Con base en la regla de negocio \BRref{RN20}{Longitud de número de boleta alumno y número de empleado} verifica que la longitud de número de boleta o número de empleado sea el correcto. \Trayref{D}
		\UCpaso Verifica que la longitud del CURP tenga la longitud correcta. \Trayref{D}
		\UCpaso Verifica que el formato del correo electrónico sea el correcto. \Trayref{E}
		\UCpaso Basado en la regla de negocio \BRref{RN1}{Unicidad del usuario} verifica que no exista un registro duplicado.
	...
	\end{UCtrayectoria}
		...
		\begin{UCtrayectoriaA}{A}{El usuario solicita cancelar la operación.}
			...
			\UCpaso Muestra la pantalla \IUref{IU5.1}{Bienvenida usuarios}
			\end{UCtrayectoriaA}
		
		\begin{UCtrayectoriaA}{B}{El usuario no ingresó todos los campos obligatorios.}
			\UCpaso  Muestra el Mensaje \MSGref{MSG50}{Campo obligatorio} en la pantalla \IUref{IU2}{Modificar información personal}.
			\UCpaso[\UCactor] Continua en el paso 4 del \UCref{CU2}.
		\end{UCtrayectoriaA}
	
		\begin{UCtrayectoriaA}{C}{El usuario ingresó campos no válidos.}
		\UCpaso  Muestra el Mensaje \MSGref{MSG51}{Campo no válido} en la pantalla \IUref{IU2}{Modificar información personal}.
		\UCpaso[\UCactor] Continua en el paso 4 del \UCref{CU2}.
	\end{UCtrayectoriaA}
	
		\begin{UCtrayectoriaA}{D}{El usuario ingresó el CURP, Número de boleta o Número de empleado con longitud incorrecta.}
		\UCpaso  Muestra el Mensaje \MSGref{MSG52}{Logitud no válida} en la pantalla \IUref{IU2}{Modificar información personal}.
		\UCpaso[\UCactor] Continua en el paso 4 del \UCref{CU2}.
	\end{UCtrayectoriaA}
	
		\begin{UCtrayectoriaA}{E}{El usuario ingresó un correo electrónico no válido.}
		\UCpaso  Muestra el Mensaje \MSGref{MSG53}{Formato no válido} en la pantalla \IUref{IU2}{Modificar información personal}.
		\UCpaso[\UCactor] Continua en el paso 4 del \UCref{CU2}.
	\end{UCtrayectoriaA}

...
\begin{UseCase}{CU2}{Modificar información personal}{
		...
		\UCitem{Reglas de Negocio}{\BRref{RN1}{Unicidad del usuario}, \BRref{RN6}{Información requerida para agregar un usuario}, \BRref{RN19}{Longitud de número de boleta alumno y número de empleado}.}
	...
	\begin{UCtrayectoria}{Principal}
		...
		\UCpaso Con base en la regla de negocio \BRref{RN19}{Longitud de número de boleta alumno y número de empleado} verifica que la longitud de número de boleta o número de empleado sea el correcto. \Trayref{D}

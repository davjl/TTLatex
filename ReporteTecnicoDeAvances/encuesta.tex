\section{Pruebas}
En este apartado se puede observar las pruebas realizadas tanto del sistema como de aceptación, las cuales nos ayudan a obtener un panorama del impacto a una futura implementación.
\subsection{Pruebas de caja negra}
Como parte del trabajo realizado se llevaron a cabo de forma breve algunas pruebas de caja negra al sistema, sin embargo, se han planeado una evaluación más exhaustiva para la fecha de conclusión de este proyecto, el compendio hasta el momento tiene como alcance probar la ruta crítica del sistema con el objetivo de encontrar posibles errores y repararlos, para lograrlo se han creado guiones de pruebas que corresponden a el módulo de emisión de pagos, al módulo del subdirector académico y al módulo de citas. Estos guiones de prueba se pueden consultar en el siguiente link https://drive.google.com/open?id=10-aau6jtjQzWaHUjf8A3kG4sds-Kotml como una referencia al lector.

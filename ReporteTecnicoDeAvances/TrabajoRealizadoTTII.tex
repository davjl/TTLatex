...
Siguiendo la tarea para la corrección de errores, nos dedicamos a mejorar el análisis planteado en la primera parte del Trabajo Terminal incluyendo a detalle la descripción de neustros atributos, actores, reglas de negocio y la separación de requerimientos funcionales y no funcionales del sitema. A continuación se muestra el trabajo realizado en cada uno de esos rubros.\\
...
\newpage
\section{Diseño e implementación WEB de módulo de impresiones y biblioteca}
...
\section{Diseño e implementación WEB de módulo de contador y subdirector}
...
\section{Diseño e implementación de módulo móvil}
...
Con la creación de esos servicios REST es que fue posible consumir la información de nuestra aplicación web para poder mostrarla al usuario final. Cabe mencionar que el uso de las tecnologías mencionadas anteriormente hace de nuestra aplicación una herramienta bastante ligera.

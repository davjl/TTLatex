...
\subsection{Requisitos funcionales}
	\begin{requerimientos}[blue]{}
		...
		\FRitem {RF32}{Historial}{Todo usuario podrá visualizar el comprobante sigaa respecto al área correspondiente.}\\
	...
	\begin{requerimientos}[blue]{}
		...
		\FRitem{RF37}{Impresión de comprobantes}{Todos los coordinadores de área, contador y subdirector administrativo podrán reealizar la impresión de los comprobantes sigaa en caso de ser necesario.}\\
	...
	\begin{requerimientos}[blue]{}
		...
		\FRitem{RF14}{Subir comprobate de pago}{El usuario (alumno, empleado, externo) podrá subir el comprobante de pago en cualquier hora}\\%------------------****************
		...
		\FRitem{RF16}{Visualizar comprobante pago}{El usuario (alumno, empleado, externo) podrá visualizar en cualquier momento el comprobante de pago enviado.}\\
		...
		\FRitem{RF19}{Gestionar notas de pago}{El usuario (alumno, empleado, externo) podrá ralizar las cualquiera de las siguientes operaciones en el comprobante de pago que elija \begin{itemize}
	...
	\begin{requerimientos}[blue]{}
		\FRitem{RF42}{Aprobar pago}{El cajero podrá aprobar un pago recibido.}\\
		\FRitem{RF43}{Rechazar pago}{El cajero podrá rechazar un pago recibido.}\\
		%\FRitem{RF}{Descripción del rechazo}{Si el pago es rechazado el cajero deberá agregar una descripción del motivo de rechazo.}\\
		\FRitem{RF41}{Adjuntar comprobante sigaa}{En caso de que el pago sea aprobado el cajero deberá adjuntar el comprobante sigaa.}\\
	...
	\begin{requerimientos}[blue]{}
		...
		\FRitem{RF26}{Visualizar cuestionario}{El dentista podrá visualizar las respuestas del cuestionario realizado por el usuario (alummno, empleado, externo)}\\
		\FRitem{RF27}{Realizar consulta}{El dentista podrá realizar una consulta aun sin previa cita y deberá agregar una descripción del tratamiento}\\
		\FRitem{RF28}{Enviar nota de pago}{El dentista solo podrá enviar una nota de pago al usuario(alumno, empleado, externo) al finalizar la consulta}\\
		\FRitem{RF29}{Gestionar pacientes}{Los dentistas podran visualizar un registro de todos sus pacientes en cualquier momento}\\
		\FRitem{RF30}{Visualizar historial clínico}{}\\
...
\begin{NFRequieriments}
	...
	\NFRitem{RNF2}{Versión de ejecución Android}{La aplicación móvil podrá ser ejecutada en el sistema operativo android 2.7}{}\\
...
\begin{BussinesRule}{BR3}{Perfilamiento de coordinadores área de servicios}
...
\begin{BussinesRule}{BR4}{Número de coordinadores área de servicios}
	\BRitem[Descripción:] En todas las áreas se podrá registrar hasta dos coordinadoreas para diferentes turnos (matutino, vespertino).
	\BRitem[Clase:]Integridad
	\BRitem[Tipo:] Cronometrada.
	\BRitem[Nivel:] Control.
\end{BussinesRule}
...
\begin{BussinesRule}{BR5}{Perfilamiento de coordinadores área administrativa}
	\BRitem[Descripción:] Para el área administrativa existirán tres tipos de rol \begin{itemize}
		\item Cajero.
		\item Contador.
...
\begin{BussinesRule}{BR9}{Estado del archivo}
	\BRitem[Descripción:] Al ser enviado un pago para revisión en caja se consideran 3 posibles estados: \begin{itemize}
...
\begin{BussinesRule}{BR11}{Archivo del comprobante de pago}
	\BRitem[Descripción:]Un comprobante de pago deberá cumplir las siguientes especificaciones: \begin{itemize}
...
\begin{BussinesRule}{BR12}{Validación de un comprobante de pago}
	\BRitem[Descripción:] Para validar un comprobante este deberá ser legible.
	\BRitem[Clase:] Condición.
	\BRitem[Tipo:] Habilitador.
	\BRitem[Nivel:] Influenciador.
\end{BussinesRule}

\begin{BussinesRule}{BR13}{Registro de coordinadores}
...
\begin{BussinesRule}{BR14}{Baja de coordinadores}
...
\begin{BussinesRule}{BR15}{Campos obligatorios}
	\BRitem[Descripción:] Los campos marcados con * deberán ser obligatorios.
	\BRitem[Clase:] Condición.
	\BRitem[Tipo:] Habilitador.
	\BRitem[Nivel:] Control.
\end{BussinesRule}

\begin{BussinesRule}{BR16}{Validación de caracteres}
...
\begin{BussinesRule}{BR17}{Periodos de cita}
...
\begin{BussinesRule}{BR18}{Horarios corte de caja}
...
\begin{BussinesRule}{BR19}{Cortes de caja ajeno al horario}
	\BRitem[Descripción:] En caso de que se tenga que realizar un corte de caja fuera del tiempo dicho anteriormente solo el subdirector administrativo podrá habilitar la función de corte de caja.
	\BRitem[Clase:] Autorización.
	\BRitem[Tipo:] Ejecutivo.
	\BRitem[Nivel:] Control.
\end{BussinesRule}

\begin{BussinesRule}{BR20}{Gestionar notas de pago}
...
\begin{BussinesRule}{BR21}{Gestionar pagos}
	\BRitem[Descripción:] En la gestion de pagos solo se visualizarán los pagos que se han mandado a caja.
	\BRitem[Clase:] Autorización.
	\BRitem[Tipo:] Habilitador.
	\BRitem[Nivel:] Control.
\end{BussinesRule}

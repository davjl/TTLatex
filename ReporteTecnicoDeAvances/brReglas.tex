...
En esta sección se presenta un compendio de algunas de las reglas de negocio extraídas durante las mesas de trabajo con las áreas contempladas en este trabajo. A continuación, se puede observar que constan descripción, clase, tipo y nivel.
...
\begin{BussinesRule}{BR29}{Emisión de pagos}
	\BRitem[Descripción:] Las formas de pago emitidas por concepto de servicios de catálogo debe ser emitida en caja o en sucursal bancaria.
	\BRitem[Clase:] Autorización.
	\BRitem[Tipo:] Habilitador.
	\BRitem[Nivel:] Control.
\end{BussinesRule}

\begin{BussinesRule}{BR30}{Comprobación de pago “en firme” vía telefónica}
...
\begin{BussinesRule}{BR}{Pagos emitidos a CELEX}
	\BRitem[Descripción:] Los pagos emitidos a CELEX deben ser obligatoriamente pagados en institución bancaria.
	\BRitem[Clase:] Autorización.
	\BRitem[Tipo:] Habilitador.
	\BRitem[Nivel:] Control.
\end{BussinesRule}

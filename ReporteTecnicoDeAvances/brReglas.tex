...
\begin{BussinesRule}{BR26}{Precio Catálogo de Servicios}
	\BRitem[Descripción:] Todos los precios de los servicios utilizados en la Escuela Superior de Cómputo deben provenir del Catálogo de servicios \cite{DEPAMIN}.
	\BRitem[Clase:]
	\BRitem[Tipo:]
	\BRitem[Nivel:]
\end{BussinesRule}

\begin{BussinesRule}{BR27}{Transferencia de efectivo a cuenta bancaria}
	\BRitem[Descripción:] Todos los pagos realizados a la escuela Superior de Cómputo deben ser transferidos después del corte de caja a la cuenta BBVA Bancomer.
	\BRitem[Clase:]
	\BRitem[Tipo:]
	\BRitem[Nivel:]
\end{BussinesRule}

\begin{BussinesRule}{BR28}{Comprobante SIG@}
	\BRitem[Descripción:] Toda pago de servicios debe emitir un comprobante SIG@.
	\BRitem[Clase:]
	\BRitem[Tipo:]
	\BRitem[Nivel:]
\end{BussinesRule}

\begin{BussinesRule}{BR29}{}
	\BRitem[Descripción:] Las formas de pago emitidas en por concepto de servicios de catálogo debe ser emitida en caja o en sucursal bancaria.
	\BRitem[Clase:]
	\BRitem[Tipo:]
	\BRitem[Nivel:]
\end{BussinesRule}

\begin{BussinesRule}{BR30}{Almacenamiento de comprobantes SIG@ y Voucher de pago}
	\BRitem[Descripción:] Todos los comprobantes SIG@ y vouchers de pago deben almacenarse por un periodo mínimo de cinco años con fines de auditoría.
	\BRitem[Clase:]
	\BRitem[Tipo:]
	\BRitem[Nivel:]
\end{BussinesRule}

\begin{BussinesRule}{BR31}{Comprobación de pago “en firme” vía telefónica}
	\BRitem[Descripción:] Los pagos emitidos por cantidades conspicuas deben ser verificados vía telefónica.
	\BRitem[Clase:]
	\BRitem[Tipo:]
	\BRitem[Nivel:]
\end{BussinesRule}

\begin{BussinesRule}{BR}{Pagos emitidos a CELEX}
	\BRitem[Descripción:] 
	\BRitem[Clase:]
	\BRitem[Tipo:]
	\BRitem[Nivel:]

...
\IUfig[1]{gui/Secuencia/RealizarPago}{}{Modelo de secuencia. Subir pago}
\begin{itemize}
	\item El usuario accede a la interfaz gráfica de adjuntarComprobante.
	...
	\item Pagos action selecciona y muestra la vista de gestiónarPagos()
	\item La interfaz gráfica muestra un mensaje del pago enviado.
\end{itemize}
\newpage

\IUfig[1]{gui/Secuencia/VisualizarPago}{}{Modelo de secuencia. Visualizar pago}
\begin{itemize}
...
\end{itemize}
\newpage
\IUfig[1]{gui/Secuencia/AprobarPago}{}{Modelo de secuencia. Aprobar pago}
\begin{itemize}
	\item El cajero ingresa a la vista de comprobantePago del pago seleccionado.
	\item Selecciona aprobar pago
	\item La interfaz gráfica llama a pagos action con el pago como parámetro.
	\item Pago action llama a pagos business con el pago seleccionado como parámetro.
	\item Pago business cambia el estado del pago a aprobado.
	\item Pago business llama al Data Access Object con el método actuaizaPago con el pago.

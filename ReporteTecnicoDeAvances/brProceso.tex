...
% - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{Proceso de pago en servicio dental}
...
% - - - - - - - - - - - - - - - - - - - - - - - - -
\subsubsection{Proceso de pago para servicios sin nota de pago}
...
\subsection{Ventajas del proceso propuesto}
Con base en la propuesta anterior se ha detectado algunas ventajas con respecto al sistema de gestión de pagos actual. Las principales ventajas consisten en:

\begin{table}[htbp]
	\begin{center}
		\begin{tabular}{|p{45mm}|p{52.5mm}|p{52.5mm}|}
			\hline
			{\bf Actor(es)}&{\bf Proceso ajustado}&{\bf Procesos actuales}\\
			\hline 
			Usaurio & Puede consultar los servicios disponibles desde la aplicación en cualquier lugar. & Debe consultar los servicios disponibles directamente en caja o área de servicio. \\
			\hline
			Usuario & El sistema es incluyente con el sistema & No se toma en cuenta la participación de los usuarios.\\
			\hline
			Coordinador de área & Puede generar una nota de pago digital. & Debe imprimir y recortar sus notas.\\
			\hline
			Usuario & Tiene la posibilidad de mandar un comprobante de pago a caja desde cualquier lugar o pagar directamente en ella. & Esta obligado a presentarse en caja para realizar un pago. \\
			\hline
			Usuario & Mantiene un registro de los pagos que ya fueron aceptados en caja. & Puede perder el comprobante SIG@ sin efectuar el servicio. \\
			\hline
			Caja & Es posible evitar la impresión de comprobantes SIG@. & La impresión de comprobantes SIG@ es obligatorio. \\
			\hline
			Áreas de servicio, Caja & Pueden almacenar los comprobantes que generen de forma digital. & Los comprobantes deben ser almacenados en carpetas o cajas.\\
			\hline
			Todas las áreas & Almacenamiento digital de comprobantes & Se tiene que almacenar el comprobante físicamente.\\
			\hline
			Áreas de servicio, Caja & Mayor velocidad de comunicación entre las áreas y los usuarios & Las áreas no se encuentran comunicadas y solo interactuan con el comprobante físico.\\
			\hline
		\end{tabular}
	\end{center}
\end{table}

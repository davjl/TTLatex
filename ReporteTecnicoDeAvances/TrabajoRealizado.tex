...
Fue necesario acordar reuniones de trabajo con la contadora pues en caja y contaduría recaen todos los depósitos y comprobantes de pago que los usuarios realizan con el fin de obtener un servicio.\\
...
\begin{itemize}
	...
	\item Visualización de comprobantes de pago y boletas SIG@.
\end{itemize}
...
\newpage
El compendio con la descripción de los 45 casos de uso se puede consultar en la siguiente dirección: https://github.com/davjl/TTLatex

\newpage
\section{Base de datos}
Como última parte del trabajo realizado para esta primera etapa, modelamos nuestra base de datos para representar el acceso a la información. Se planteó un primer diseño que consider un flujo simple para el proceso de pago en nuestro sistema.\\

...
Para poder comprender mejor el desarrollo de este Trabajo Terminal definiremos algunos conceptos técnicos principales a partir de los cuales basamos nuestro proyecto. Los conceptos a considerar son: aplicación web; aplicación móvil; Interfaz de Programación de Aplicaciones (API); aplicación móvil nativa; aplicaciones web sobre móviles; aplicación móvil híbrida; framework.
Además se otorga una descripción del modelo y herramientas de trabajo utilizadas en el desarrollo, de las cuales se realizo una comparativa para decidir si eran las más efectivas para este trabajo. El modelo utilizado es: Modelo Vista Controlador (MVC) y las herramientas utilizadas son: Spring Boot; Struts 2; Hibernate ORM; y por último, Xamarin.\\

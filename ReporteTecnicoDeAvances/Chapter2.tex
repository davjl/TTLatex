...
\label{Capitulo 2} 
En este capítulo se habla del actual proceso de pagos que se realiza en la ESCOM y se menciona de forma general el problema que existe derivado de esto. Se proporciona un marco teórico para entender los conceptos y tecnologías que se utilizan. \\
...
\newpage
Si bien este flujo es comun en la mayoria de las áreas de servicio también pueden existir algunas variantes en este proceso como es el caso de área dental el cual ponemos ver en la figura \ref{fig:PagoDentales}
...
Para poder observar a detalle el flujo de los sub-procesos se recomienda ver el Anexo V : Diagramas.
...
Con base en el catalogo de productos y cuotas de aprovechamiento de Cobro Regular emitido por la SHCP a través del sistema DEPAMIN \cite{DEPAMIN}, la Escuela Superior de Cómputo y el presente trabajo terminal hacemos uso de los siguientes servicios descritos a continuación:

...
Dicho catálogo se renueva año con año presentando una relación aproximadamente de 1200 cuotas de productos y 19 cuotas de aprovechamientos de Cobro Regular \cite{catalogo}. Cada una de esas cuotas es incorporada en el Sistema Institucional de Gestión Administrativa (SIG@) del IPN \cite{SIGA}, poniendo a disposición una comprobante SIG@, relacionada con cada cuota.\\

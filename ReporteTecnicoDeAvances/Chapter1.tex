...
--Actualmente en la Escuela Superior de Cómputo (ESCOM) del Instituto Politécnico Nacional (IPN) se otorgan una variedad de servicios tanto para alumnos, empleados y personal externo que permiten obtener una ganancia generada para la misma escuela.

Los servicios de más uso por parte de los usuarios está enfocado a las áreas de servicios dentales, impresiones, CELEX y biblioteca, las cuales para poder otorgar un servicio, es necesario la elaboración de un pago efectuado dentro del sistema de caja de ESCOM. Cabe mencionar que en caso de servicios CELEX los pagos se generan por medio del sistema bancario BBVA Bancomer, el cual, luego de generar el pago es necesario llevar el comprobante de pago a caja.

Después de realizar el pago en caja, se nos hace entrega de un comprobante de pago para proporcionar al área en que solicito el servicio y pueda ser efectuado. Solo en servicos dentales ocurre el caso en que primero se realiza el servicio y luego se genera el pago. Todos estos comprobantes se tienen que almacenar por un periodo de 5 años en todas las áreas de servicio y contabilidad.

Para este Trabajo Terminal se tiene planeado desarrollar un sistema por el cual la consulta de servicios, la realización de pagos e impresión de comprobantes no sean una obligación de realizar físicamente y se logre efectuar un medio digital de consulta y comunicación entre áreas de servicios escolares - caja - usuario.--

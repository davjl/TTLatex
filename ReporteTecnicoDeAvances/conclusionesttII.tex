...
Este proyecto no sólo implicó resultados tecnológicos, sino también personales y de equipo pues el trabajo de este sistema nos hizo aplicar nuestras habilidads blandas como personas para poder lograr un buen trabaja de equipo y saber sobrellevar nuestras diferencias. Nos atrevemos a decir que lo más complicado de este proyecto fue el trato humano, las relaciones inter personales y el acuerdo en equipo.\\

Estas son habilidades que no se forman del todo en la trayectoria académica, pero nos hemos dado cuenta que forman la parte más importante de todo proyecto, incluso después de las habilidades y conocimientos técnicos que se tengan.\\

Sin duda, este Trabajo Terminal representó una buena prueba para la consolidación de cada uno de nosotros como profesionistas y seres humanos.

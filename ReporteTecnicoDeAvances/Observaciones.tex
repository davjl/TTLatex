\section{Avances logrados en TT I}
...
\section{Retroalimentación de TT I}

Luego de la primera presentación de Trabajo Terminal y de los avances descritos anteriormente, los sinodales hicieron mención de las siguientes observaciones:\\
...
Para atender esas observaciones realizamos lo siguiente:\\
...
Por último, el idioma del sistema fue cambiado por completo al español. De este modo, se lograron atender todas las observaciones realizadas en la primera parte de este Trabajo Terminal. En el siguiente capítulo se hablará más a detalle sobre cada una de estas soluciones, además de describir todo el trabajo realizado para la segunda parte del Trabajo Terminal.\\
